...
try:
    ...
    st.markdown("---")
    st.markdown("🔮 **Как использовать этот квадрат:**")
    st.markdown(
        ...
        "✅ Распечатайте квадрат, заламинируйте его или перенесите на любую поверхность (бумагу, дерево, ткань).\n"
        "🎨 Вы можете раскрасить его интуитивно или в соответствии с цветами планет в ведической нумерологии.\n"
        "🧘 Разместите его на рабочем столе, в личной зоне, рядом с алтарём или используйте для медитации.\n\n"
        "📜 За подробной расшифровкой значений чисел и квадратов обращайтесь к профессиональному нумерологу."
    )
